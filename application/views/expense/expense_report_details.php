                    ...
                    <div class="first">
                        <div class="second">
                            <table border="1" style="width: 90%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 40px;">
                                <tr>
                                    <td colspan="5" style="text-align: center">Expense From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                                </tr>
                                <tr>
                                    <td>Sl</td>
                                    <td>Voucher No</td>
                                ...
                                foreach ($query as $query_value) {
                                    ...
                                    $sql_head = $this->db->where('expense_head_id', $query_value->expense_head_id)
                                            ->get('expense_head')
                                            ->row();
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $sql_head->expense_head_name ?>
                                        </td>
                                        <td>
                                            <?php
