<tr>
    <td style="padding:5px;">
        ...
        <input type="hidden" class="form-control" id="test_category_id_<?php echo $next_id ?>" name="test_category_id[]">
    </td>
    <td style="padding:5px;">

        <input type="text" value="1" oninput="total_price_cal(this.id)" id="quantity_<?php echo $next_id ?>" name="quantity[]" class="form-control" sequence=<?php echo $next_id ?> required="" onkeyup="getamount(this, event)">
    </td>
    <td style="padding:5px;">
        <input type="text" id="price_<?php echo $next_id ?>" name="price[]" class="form-control" sequence=<?php echo $next_id ?> required="" onkeyup="getamount(this, event)">
    </td>

    <td style="padding:5px;">
        <input type="text" id="amount_<?php echo $next_id ?>" name="amount[]" oninput="total_price_cal_unit_price(this.id)" class="form-control amount" readonly="" sequence=<?php echo $next_id ?>>
    </td>
    <td style="padding:5px;">
