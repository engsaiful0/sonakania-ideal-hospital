...
<script>
    $(document).ready(function() {
        ...
        $("#patient_unique_id").autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: "<?php echo site_url('DischargeController/undischarged_patient_unique_id_load_for_edit'); ?>",
                    data: {
                        parameter: request.term
                    },
                    dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#discharge_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('DischargeController/update_discharge_data'); ?>",
                    data: formData,
                    dataType: "json",
    ...
    function net_payable_calculate() {
        ...
        if (special_discount.includes("%")) {
            ...
            $('#due').val(Math.ceil(Number(payable) - Number(total_discount)));

        } else {
            var payable = $('#payable').val();
            $('#net_payable').val(Math.ceil(Number(payable) - Number(special_discount)));
            $('#due').val(Math.ceil(Number(payable) - Number(special_discount)));
        }
...
<div class="container-fluid" style=" background-color: white;width: 98%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Update Discharge</h3>
        </div>
        <?php
                    ...
                    <form id="discharge_entry_form" class="form-horizontal" method="post" enctype='multipart/form-data'>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?php echo date('d-m-Y', strtotime($discharge->discharge_date)) ?>" placeholder="Discharge Date" id="discharge_date" name="discharge_date">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input value="<?php echo $discharge->patient_unique_id ?>" type="text" placeholder="Scan of Type IPD Patient Id.." class="form-control" id="patient_unique_id" name="patient_unique_id">
                        ...
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input readonly type="text" placeholder="Year" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo  $patient->age_year ?>" id="age_year" name="age_year">
                                    </div>
                                    <div class="col-sm-3">
                                        <input readonly type="text" placeholder="Month" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo  $patient->age_month ?>" id="age_month" name="age_month">
                                    </div>
                                    <div class="col-sm-3">
                                        <input readonly type="text" placeholder="Day" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo  $patient->age_day ?>" id="age_day" name="age_day">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <fieldset style="background-color:whitesmoke;margin-top:30px;">
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label col-sm-6" id="cabin_or_bed" for="pwd"><span id="cabin_or_bed_bill_show"><?php echo  $discharge->bed_or_cabin_charge ?></span></label>
                                        <div class="col-sm-6">
                                            <input placeholder="Cabin/Bed Rent" type="hidden" class="form-control" value="<?php echo  $discharge->bed_or_cabin_charge ?>" id="bed_or_cabin_charge" name="bed_or_cabin_charge">
                            ...
                            <div class="row" style="margin-top:20px;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label col-sm-6" for="pwd">Service Fee*</label>
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Service Fee" type="text" class="form-control" value="<?php echo  $discharge->admission_and_other_bill ?>" required="" id="admission_and_other_bill" name="admission_and_other_bill">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="OT Amount" type="text" class="form-control" value="<?php echo  $discharge->ot_service_bill ?>" id="ot_service_bill" name="ot_service_bill">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Admission Reg Fee" type="text" value="<?php echo  $discharge->admission_reg_fee ?>" class="form-control" id="admission_reg_fee" name="admission_reg_fee">
                            ...
                            <div class="row" style="clear:left;margin-top:20px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Assistant Fee" type="text" value="<?php echo  $discharge->assistatnt_fee ?>" class="form-control" id="assistatnt_fee" name="assistatnt_fee">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Consultant Fee" type="text" class="form-control" id="consultant_fee" value="<?php echo  $discharge->consultant_fee ?>" name="consultant_fee">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Service Charge" type="text" class="form-control" id="service_charge" value="<?php echo  $discharge->service_charge ?>" name="service_charge">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Extra Hours Bill" type="text" class="form-control" id="extra_hours_bill" value="<?php echo  $discharge->extra_hours_bill ?>" name="extra_hours_bill">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row" style="margin-top:20px;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input onkeydown="validateNumberInputWithPercentage(event)" placeholder="Special Discount Amount" onchange="net_payable_calculate()" type="text" class="form-control" value="<?php echo  $discharge->special_discount ?>" id="special_discount" name="special_discount">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input onkeydown="validateNumberInput(event)" placeholder="Enter Paid Amount" onchange="due_calculate(this.value)" type="text" class="form-control" value="<?php echo  $discharge->paid ?>" id="paid" name="paid">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group" id="bank_container" style="display:<?php echo $bank_container ?>">
                                                <select style="width: 170px;" type="text" class="form-control" id="bank_account_id" name="bank_account_id">
                                                    ...
                                                    ?>
                                                        <option <?php echo $discharge->bank_account_id == $bank_account->bank_account_id ? "selected" : "" ?> value="<?php echo $bank_account->bank_name_id ?>"><?php echo $bank_name->name . '-' . $bank_account->account_number . '-' . $bank_account->account_name ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="form-group" id="mobile_banking_container" style="display:<?php echo $mobile_banking_container ?>">
                                                <select style="width: 170px;" type="text" class="form-control" id="mobile_bank_id" name="mobile_bank_id">
                                                    ...
                                                    ?>
                                                        <option <?php echo $discharge->mobile_bank_id == $mobile_bank->mobile_bank_id ? "selected" : "" ?> value="<?php echo $mobile_bank->mobile_bank_id  ?>"><?php echo $mobile_bank->account_name . '-' . $mobile_bank->account_number . '-' . $mobile_bank->type ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="discount_reference" value="<?php echo  $discharge->discount_reference ?>" placeholder="Enter Discount Ref.." name="discount_reference">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top:20px;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input readonly placeholder="Enter Amount" type="text" class="form-control" value="<?php echo  $discharge->due ?>" id="due" name="due">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
