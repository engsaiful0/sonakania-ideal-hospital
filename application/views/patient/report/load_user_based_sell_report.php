<div class="panel-heading" style="font-weight: bold;text-align: center;">
    ...
    ?>
    <p style="clear:left;text-align: center">Today My Sell Report. Date:<b><?php echo date('Y-m-d', strtotime($from_date)) . ' To ' . date('Y-m-d', strtotime($to_date)) ?></b> <br>
        ...
        <div class="col-md-12">
            <table border="1" style="width: 100%;border-collapse:collapse;margin:0 auto;color:black;">
                ...
                <tr>
                    ...
                    <td id="total_paid_<?php echo $user_id ?>">
                    ...
                    <td id="total_return_<?php echo $user_id ?>">
                        <?php
                    ...
                    <td id="total_balance_<?php echo $user_id ?>">
                        <?php
...
');
                ...
                <tr>
                    ...
                    <!-- <td><strong><?php echo number_format($grand_test_total_paid_each - $total_test_due) ?></strong></td> -->
            ...
            ?>
            <table border="1" style="border-collapse:collapse;margin:0 auto;color:black;position:top;display:none">
