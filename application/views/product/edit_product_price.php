...
<div class="container" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Edit Product Price</h3>
        </div>
        <div class="panel-body">
            ...
            ?>
            <form class="form-horizontal" method="post" action="<?php echo site_url('ProductController/edit_product_price_save') ?>" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">          
                        <select type="text" required=""  class="form-control" id="model_id" placeholder="Enter Model" name="model_id">
