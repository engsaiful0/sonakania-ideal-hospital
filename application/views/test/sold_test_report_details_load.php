...
<html>
    <head>
        ...
        <title>Daily Test Sales Report</title>
    </head>
    <body>
        <?php
         error_reporting(0);
            ...
            <div class="first">
                <div class="second">
                    <table border="1" border="1" style="width: 98%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 30px;">
                        ...
                        <tr>
                            <td colspan="8" style="text-align: center">Daily Test Sales Report From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                        </tr>
...
//            ->result();
                        ...
                        foreach ($query as $query_value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    echo $query_value->total_price;
                                    $grand_total_price += $query_value->total_price;
                                    ?>
                                </td>
                                <td>
        <?php echo date('d-m-Y', strtotime($query_value->date)) ?>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold"><?php echo $grand_quantity ?></td>
                            <td></td>
                            <td style="font-weight: bold"><?php echo $grand_total_price ?></td>
