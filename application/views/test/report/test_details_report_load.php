                ...
                <div class="second">
                    <table border="1" border="1" style="width: 98%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 30px;">
                        <tr style="background-color:#337AB7;color: white  ">
                            <td colspan="8" style="text-align: center">Test Details Report From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                        </tr>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    $grand_total += $query_value->total_price;
                                    ?>
                                </td>
                                <td>
