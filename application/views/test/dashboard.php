    ...
    <?php if (in_array('patient_dashboard', $permissions)) { ?>
        ...
        <div class="panel panel-primary" style="width: 100%; margin: 0 auto;">
            <div class="panel-heading">
                <h3 style="text-align: center;">Test Dashboard</h3>
            </div>
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    // Fetch the sum of the amount from the patient_test_entry table for the current account for today
                    $total_test_entry_today = $this->db->select('COUNT(*) as total')
                        ->where('date', $today)
                    ...
                    $total_sub_total_amount_today = $this->db->select_sum('sub_total')
                        ->where('date', $today) // Filter for today's date
                        ->get('patient_test_entry')
                        ->row()
                        ->sub_total;

                    $total_discount_amount_today = $this->db->select_sum('total_discount')
                        ->where('date', $today) // Filter for today's date
                        ->get('patient_test_entry')
                        ->row()
                        ->total_discount;
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-cherry">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Sell Amount</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_sub_total_amount_today);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_discount_amount_today);
                                            ?>
                                        </h2>
                                    </div>
                ...
                <fieldset>
                    ...
                    // Fetch the sum of the amount from the medicine_sales table for the current month
                    $total_test_entry_month = $this->db->select('COUNT(*) as total')
                    ...
                    $total_total_sub_total_amount_month =  $this->db->select_sum('sub_total')
                        ->where('date >=', $first_day_of_month)
                        ->where('date <=', $last_day_of_month)
                        ->get('patient_test_entry')
                        ->row()
                    ...
                    $total_total_discount_amount_month =  $this->db->select_sum('total_discount')
                        ->where('date >=', $first_day_of_month)
                        ->where('date <=', $last_day_of_month)
                        ->get('patient_test_entry')
                        ->row()
                    ...
                    $this->db->where('date >=', $first_day_of_month)
                        ->where('date <=', $last_day_of_month); // Filter by today's date
                    $query = $this->db->get();
                    $total_test_due_collection_month = $query->row()->paid ?? 0; // Return 0 if no income found
                    ...
                    $this->db->where('date >=', $first_day_of_month)
                        ->where('date <=', $last_day_of_month); // Filter by today's date
                    $query = $this->db->get();
                    $total_test_sell_collection_month = $query->row()->paid ?? 0; // Return 0 if no income found
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_total_sub_total_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_test_sell_collection_month);
                                            ?>
                                        </h2>
                                    </div>
                                </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_total_discount_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_test_due_collection_month);
                                            ?>
                                        </h2>
                                    </div>
                                </div>
                ...
                <fieldset>
                    ...
                    $total_test_sub_total_amount_year = $this->db->select_sum('sub_total')
                    ...
                    $total_test_sell_amount_year = $this->db->select_sum('net_total')
                        ->where('date >=', $first_day_of_year)
                        ->where('date <=', $last_day_of_year)
                        ->get('patient_test_entry')
                        ->row()
                    ...
                    $total_total_discount_amount_year =  $this->db->select_sum('total_discount')
                        ->where('date >=', $first_day_of_year)
                        ->where('date <=', $last_day_of_year)
                        ->get('patient_test_entry')
                        ->row()
                    ...
                    $this->db->where('date >=', $first_day_of_year)
                        ->where('date <=', $last_day_of_year); // Filter by today's date
                    $query = $this->db->get();
                    $total_test_sell_collection_this_year = $query->row()->paid ?? 0; // Return 0 if no income found
                    ...
                    $this->db->where('date >=', $first_day_of_year)
                        ->where('date <=', $last_day_of_year); // Filter by today's date
                    $query = $this->db->get();
                    $total_test_due_collection_this_year = $query->row()->paid ?? 0; // Return 0 if no income found
                    ?>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_test_sub_total_amount_year);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_test_sell_collection_this_year);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_total_discount_amount_year);
                                            ?>
                                        </h2>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large"><i class="fas fa-ticket-alt"></i></div>
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Sell Due Collection</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_test_due_collection_this_year);
                                            ?>
                                        </h2>
                                    </div>
