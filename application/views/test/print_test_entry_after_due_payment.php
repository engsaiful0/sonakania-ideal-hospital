    ...
    <div class="customer-copy" style="margin-top: 50px; ">
        <div class="" style="width: 100%;margin-bottom: 10px;">
            ...
            <div style="width: 70%;float: left;text-align: center">
                <p style="text-align: center"><span style="text-align: center;font-size: 20px;text-align: center "> <?php echo $compnay->company_name ?><br><?php echo $compnay->address ?></span>
        ...
        <p style="text-align: right;padding-right: 10px;padding-top: 20px; ">Entry By: <span><?php echo  $user->name ?? "" ?></span></p>
    </div>
</div>