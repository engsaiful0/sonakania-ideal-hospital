    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#ot_service_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('OTServiceController/save_ot_service_due_payment_data'); ?>",
                    data: formData,
                    dataType: "json",
...
<div class="container-fluid" style=" background-color: white;width: 98%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">OT Service Due Payment</h3>
        </div>
        ...
        <div class="panel-body">
            <form id="ot_service_entry_form" class="form-horizontal" method="post" enctype='multipart/form-data'>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input readonly onchange="patient_data_set(this.value)" placeholder="Scan or Enter IPD Patient ID.." type="text" value="<?php echo $ot_service->patient_unique_id ?>" id="patient_unique_id" name="patient_unique_id" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input readonly type="text" required="" value="<?php echo date('d-m-Y', strtotime($ot_service->date)); ?>" class="form-control" id="datepicker" name="date">
                            </div>
                            <div class="col-sm-4">
                                <?php date_default_timezone_set('Asia/Dhaka'); ?>
                                <input readonly type="text" class="form-control" id="time"
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" placeholder="Enter Patient Name" class="form-control" value="<?php echo !empty($ot_service->patient_name) ? $ot_service->patient_name : ''; ?>" id="patient_name" name="patient_name">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" placeholder="Enter Mobile Number" class="form-control" value="<?php echo !empty($ot_service->mobile_number) ? $ot_service->mobile_number : ''; ?>" id="mobile_number" name="mobile_number">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input readonly type="text" placeholder="Year" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $ot_service->age_year ?>" id="age_year" name="age_year">
                            </div>
                            <div class="col-sm-3">
                                <input readonly type="text" placeholder="Month" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $ot_service->age_month ?>" id="age_month" name="age_month">
                            </div>
                            <div class="col-sm-3">
                                <input readonly type="text" placeholder="Day" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $ot_service->age_day ?>" id="age_day" name="age_day">
                            </div>
                ...
                <div class="row" style="margin-top:20px;">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" placeholder="Enter Address" class="form-control" <?php echo !empty($ot_service->address) ? $ot_service->address : ''; ?> id="address" name="address">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select disabled onchange="surgery_price_load(this.value)" name="surgery_id" class="form-control" id="surgery_id" required="">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" readonly placeholder="Enter Price" value="<?php echo $ot_service->price ?>" class="form-control" id="price" name="price">
                            </div>
                        </div>
                    </div>
                ...
                <div style="margin-top:20px;">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" oninput="payable_calculate()" placeholder="Enter Discount" class="form-control" value="<?php echo $ot_service->discount ?>" id="discount" name="discount">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" class="form-control" id="discount_reference" placeholder="Enter Discount Ref.." value="<?php echo $ot_service->discount_reference ?>" name="discount_reference">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" readonly placeholder="Total Discount" class="form-control" id="total_discount" value="<?php echo $ot_service->total_discount ?>" name="total_discount">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top:20px;">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" readonly placeholder="Enter Price" class="form-control" id="net_price" value="<?php echo $ot_service->net_price ?>" name="net_price">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" oninput="due_cal()" placeholder="Enter Paid" class="form-control" value="<?php echo $ot_service->paid ?>" id="paid" name="paid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input readonly type="text" readonly placeholder="Due" class="form-control" id="due" value="0" name="due">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-md-4">
                        <div style="background-color:#006ADC;color:black">
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="name">Due Payment</label>
                                <div class="col-sm-8">
                                    <input readonly autofocus type="text" placeholder="Enter Paid" class="form-control" value="<?php echo $ot_service->due ?>" id="due_payment" name="due_payment">
                                </div>
                            </div>
                        </div>
                    </div>
