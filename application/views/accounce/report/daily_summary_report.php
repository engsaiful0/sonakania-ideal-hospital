<script>
    function daily_summary_report_details() {
        ...
        window.open(
            '<?php echo site_url('ReportAccountController/daily_summary_report_details'); ?>' + "/" + ids,
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 style="text-align: center">Income Vs Expense Report</h3>
    </div>
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" class="btn btn-primary " onclick="daily_summary_report_details()" value="Search"></td>
            </tr>
        </table>
        <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img" style="display:none" />
        <div id="daily_summary_report_details">
