        ...
        <div class="first">
            <div class="second">
                ...
                <table border="1" class="table table-bordered table-hover" style="width: 100%;margin: 0 auto;color:black;border-collapse:collapse;">
                    <tr style="background-color: #1A7DFF;color: black">
                    ...
                    foreach ($users as $user_value) {
                        ...
                        $grand_net_test += $test_collection + $test_due_collection - $test_returnable_amount;
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo  number_format($test_due_collection) ?></td>
                            <td><?php echo  number_format($test_returnable_amount) ?></td>
                            <td><?php echo  number_format($test_collection + $test_due_collection - $test_returnable_amount) ?></td>
                    ...
                    <tr style="font-weight:bold">
                        ...
                        <td><?php echo  number_format($grand_test_collection_amount) ?></td>
                        <td><?php echo  number_format($grand_test_return_amount) ?></td>
                        <td><?php echo  number_format($grand_net_test) ?></td>
...
');
                    ...
                    <table border="1" class="table table-bordered table-hover" style="width: 100%;margin-top:10px;color:black;border-collapse:collapse;">
                        <tr style="background-color: #1A7DFF;color: black">
                            <td colspan="8" style="text-align: center">Test</td>
                        </tr>
                        <tr>
                            <td>Department</td>
                            <td>Total Entry</td>
                        ...
                        <?php
                        $this->db->select_sum('due'); // Select the sum of the 'due' column
                        $this->db->from('patient_test_entry');
                        $this->db->where('paid_or_due_status', 'due');
                        $this->db->where('date >=', $from_date);
                        $this->db->where('date <=', $to_date);
                        $query = $this->db->get();
                        $result = $query->row(); // Get the single row result
                        $total_test_due = $result->due; // Access the summed value
    ...
    ');
                        ...
                        ?>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><?php echo number_format($test_total_price-$test_total_discount_each - $test_total_return_each_category) ?></td>
                            </tr>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo number_format($grand_test_total_return_each_category) ?></strong></td>
                             <td><strong><?php echo number_format($grand_test_total_price-$grand_test_total_discount_each - $grand_test_total_return_each_category) ?></strong></td>
                            <td><strong><?php echo $total_test_due?></strong></td>
                            <td><strong><?php echo number_format($grand_test_total_price-$grand_test_total_discount_each - $grand_test_total_return_each_category-$total_test_due) ?></strong></td>
                        </tr>
                    </table>
                    <table border="1" class="table table-bordered table-hover" style="width: 100%;margin-top:10px;color:black;border-collapse:collapse;">
                        <tr style="background-color: #1A7DFF;color: black">
                ...
                <div id="balance" style="clear:left;margin-top: 50px; ">
                    <table border="1" class="table table-bordered table-hover" style="width: 100%;margin-top:10px;color:black;border-collapse:collapse;">
                        ...
                        <tr>
                            <td><?php echo number_format($grand_total_collection_amount) ?></td>
                            <td><?php echo number_format($grand_debit_amount) ?></td>
                            <td><?php echo number_format($grand_total_collection_amount - $grand_debit_amount) ?></td>
                        </tr>
                    </table>
