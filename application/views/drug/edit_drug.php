    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#drug_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('DrugController/edit_drug_data_save'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                window.location.href = "<?php echo base_url() . "index.php/DrugController/view_drug"; ?>";
                            }, 1002);
                        } else {
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Edit Medicine</h3>
        </div>
        <div class="panel-body">
            <?php
            $drug = $this->db->where('drug_id', $drug_id)->get('drug')->row();
            ?>
            <form class="form-horizontal" id="drug_entry_form" method="post" enctype='multipart/form-data'>
                <input type="hidden" value="<?php echo $drug->drug_id ?> " class="form-control" id="drug_id" name="drug_id">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="manufacturer_id" name="manufacturer_id">
                                    ...
                                    ?>
                                        <option <?php echo $value->manufacturer_id == $drug->manufacturer_id ? "selected" : "" ?> value="<?php echo $value->manufacturer_id ?>"><?php echo $value->name ?></option>
                                    <?php
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="drug_type_id" class="form-control" id="drug_type_id">
                                    ...
                                    ?>
                                        <option <?php echo $value->drug_type_id == $drug->drug_type_id ? "selected" : "" ?> value="<?php echo $value->drug_type_id ?>"><?php echo $value->type_name ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                ...
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="<?php echo $drug->drug_name ?> " class="form-control" placeholder="Enter medicine name" id="drug_name" name="drug_name">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row" style="margin-top:20px;display:none">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo $drug->strenght ?> " placeholder="Enter Strength" id="strenght" name="strenght">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="shelf_id" class="form-control" id="shelf_id">
                                    ...
                                    ?>
                                        <option <?php echo $value->shelf_id == $drug->shelf_id ? "selected" : "" ?> value="<?php echo $value->shelf_id ?>"><?php echo $value->shelf_number ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" placeholder="Enter Purchase Rate" class="form-control" value="<?php echo $drug->purchase_rate ?> " id="purchase_rate" name="purchase_rate">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" placeholder="Enter MRP" class="form-control" value="<?php echo $drug->mrp ?> " id="mrp" name="mrp">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top:20px;display:none">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" placeholder="Enter whole sale rate" class="form-control" id="whole_sale_rate" value="<?php echo $drug->whole_sale_rate ?> " name="whole_sale_rate">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" placeholder="Enter opening stock" class="form-control" id="opening_stock" value="<?php echo $drug->opening_stock ?> " name="opening_stock">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top:20px">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" placeholder="Enter reorder quantity" class="form-control" value="<?php echo $drug->reorder_quantity ?> " id="reorder_quantity" name="reorder_quantity">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="status" class="form-control" id="status">
                                    <option <?php echo $drug->status=='Active'?'selected':'' ?>>Active</option>
                                    <option <?php echo $drug->status=='Inactive'?'selected':'' ?>>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
