...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Edit Doctor Commission Payment</h3>
        </div>
        ...
        <div class="panel-body">
            ...
            $doctor_commission_payment = $this->db->where('doctor_commission_payment_id', $doctor_commission_payment_id)->get('doctor_commission_payment')->row();
            $doctor_id = $doctor_commission_payment->doctor_id;
            //   print_r($doctor_id);
            ?>
            <div class="" style="width: 90%;float: left;margin: 0 auto">


                <form class="form-horizontal" method="post" action="<?php echo site_url('DoctorController/edit_doctor_payment_save') ?>" enctype='multipart/form-data'>
                    <input id="doctor_commission_payment_id" type="hidden" value="<?php echo $doctor_commission_payment_id ?>" name="doctor_commission_payment_id">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select type="text" onchange="due_history_load(this.value)" required="" class="form-control"  id="doctor_id" name="doctor_id">                                     
                                        <?php
                                        $doctor_edit = $this->db->where('doctor_id', $doctor_id)->get('doctor')->row();
                                        ?>
                                        <option value="<?php echo $doctor_edit->doctor_id; ?>"><?php echo $doctor_edit->doctor_name . '-' . $doctor_edit->doctor_unique_id; ?></option>
                                        <?php
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"  required="" value="<?php echo date('d-m-Y', strtotime($doctor_commission_payment->date)) ?>" class="form-control" name="date" id="datepicker">
                                </div>
                            </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">  
                                    ...
                                    <input type="text" readonly="" class="form-control"   id="total_due_commission" value="<?php echo $doctor_commission_payment->total_due_commission ?>"  name="total_due_commission">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">  
                                    ...
                                    <select type="text"  class="form-control"   id="cash_or_bank" onchange="bank_name_load(this.value)" name="cash_or_bank">
                                        <option><?php echo $doctor_commission_payment->cash_or_bank ?></option>
                                        <option>Cash</option>
                                        <option>Bank</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">  
                                    <select type="text"  class="form-control"   id="bank_id"  name="bank_id">
                                        <?php
                                        $bank_selected = $this->db
                                                        ->where('bank_id', $doctor_commission_payment->bank_id)
                                                        ->get('bank')->row();
                                        ?>

                                        <option value="<?php echo $bank_selected->bank_id ?>"><?php echo $bank_selected->bank_name . '-' . $bank_selected->account_number . '-' . $bank_selected->account_name ?></option>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">  
                                    ...
                                    <input type="text"  class="form-control" required="" value="<?php echo $doctor_commission_payment->paid_amount ?>" oninput="current_due_cal()" id="paid_amount"  name="paid_amount">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">  
                                    <input type="text"  class="form-control" required=""  id="current_due_commission" value="<?php echo $doctor_commission_payment->current_due_commission ?>"  name="current_due_commission">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">        
                                <div class="col-sm-offset-4 col-sm-4">
                                    <button type="submit" onclick="return confirm('Do you want to submit?')" class="btn btn-primary">Update</button>
                                </div>
                                <div class="col-sm-4">
