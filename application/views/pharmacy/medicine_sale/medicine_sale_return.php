    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#medicine_sale_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('MedicineSaleReturnController/medicine_sale_return_save'); ?>",
                    data: formData,
                    dataType: "json",
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Medicine Sell Return</h3>
        </div>
                                        ...
                                        <table width="100%" cellpadding="4" border="0" id="cart_tab1">
                                            ...
                                            foreach ($medicine_sales_details as $value_de) {
                                                ...
                                                $drug_name = $this->db
                                                    ...
                                                    ->get('drug')->row();
                                            ?>
                                                <input type="hidden" value="<?php echo $value_de->sales_rate ?>" id="sales_rate<?php echo $seq ?>" name="sales_rate[]" class="form-control" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                <tr>
                                                    ...
                                                    <td style="padding:5px;">
                                                        <?php echo $value_de->quantity ?>
                                                        <input type="hidden" value="<?php echo $value_de->quantity ?>" id="sale_quantity<?php echo $seq ?>" name="sale_quantity[]" class="form-control" onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>
                                                    <td style="padding:5px;">
                                                        <input type="text" id="return_quantity<?php echo $seq ?>" name="return_quantity[]" class="form-control" onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>
                                                    <td style="padding:5px;">
                                                    ...
                                                    <td style="padding:5px;">
                                                        <input type="text" id="amount<?php echo $seq ?>" name="amount[]" class="form-control amount" readonly="" sequence=<?php echo $seq ?>>
                                                    </td>
                                                </tr>
                                            <?php
                                                $seq++;
