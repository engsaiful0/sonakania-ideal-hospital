    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#medicine_sale_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('MedicineSaleController/medicine_sale_edit_save'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Medicine Sale Edit</h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input value="<?php echo $medicine_sale->ipd_patient_id ?>" type="hidden" id="ipd_patient_id" name="ipd_patient_id">
                                        <input value="<?php echo $medicine_sale->opd_patient_id ?>" type="hidden" id="opd_patient_id" name="opd_patient_id">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readOnly="" required="" value="<?php echo date('d-m-Y', strtotime($medicine_sale->bill_date)); ?>" class="form-control" id="" name="bill_date">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly="" class="form-control" value="<?php echo $medicine_sale->medicine_sale_invoice_no ?>" id="medicine_sale_invoice_no" name="medicine_sale_invoice_no">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top:20px">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" placeholder="Enter Name" value="<?php echo $medicine_sale->name ?>" class="form-control" id="name" name="name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="Year" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $medicine_sale->age_year ?>" id="age_year" name="age_year">
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="Month" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $medicine_sale->age_month ?>" id="age_month" name="age_month">
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" placeholder="Day" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $medicine_sale->age_day ?>" id="age_day" name="age_day">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" oninput="validatePhoneNumberInput(this)" placeholder="Enter Mobile Number" class="form-control" value="<?php echo $medicine_sale->mobile_number ?>" id="mobile_number" name="mobile_number">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top:20px">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" placeholder="Enter Address" class="form-control" id="address" value="<?php echo $medicine_sale->address ?>" name="address">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                        ...
                                        <table width="100%" cellpadding="4" border="0" id="cart_tab1">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type=" text" placeholder="Enter Medicine Name" value="<?php echo $drug_name->drug_name ?>" id="drug_id0" sequence=0 name="drug_id[]" class="form-control" ">
                                                </td>

                                                    <td style=" padding:5px;">
                                                        <input type="text" value="<?php echo $value_de->sales_rate ?>" id="sales_rate<?php echo $seq ?>" name="sales_rate[]" class="form-control" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>

                                                    <td style="padding:5px;">
                                                        <input type="number" value="<?php echo $value_de->quantity ?>" id="quantity<?php echo $seq ?>" name="quantity[]" class="form-control" onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>
                                                    <td style="padding:5px;">
                            ...
                            <table style="margin-top:5px;float:right;width:60%">
                                <tr>
                                    ...
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Discount(%):&nbsp;</b>
                                        <input value="<?php echo $medicine_sale->discount ?>" type="text" name="discount" id="discount" class="form-control" style="width:200px;float: right;" value="0" onkeyup="totalamount()">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <b>Discount Reference</b>
                                        <input placeholder="Enter Discount Reference" type="text" value="<?php echo $medicine_sale->discount_reference ?>" name="discount_reference" id="discount_reference" class="form-control" style="width:200px;float: right;">
                                    </td>
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Total Discount</b>
                                ...
                                <tr>
                                    ...
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Paid:&nbsp;</b>
                                        <input value="<?php echo $medicine_sale->paid ?>" type="text" name="paid" id="paid" oninput="dueCal()" required="" class="form-control" style="width:200px;float: right;" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" valign="middle" style="padding:5px;">
