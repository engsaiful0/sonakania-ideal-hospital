<script>
    function daily_medicin_sell_report_details_load() {
        ...
        window.open(
                '<?php echo site_url('PharmacyController/daily_medicin_sell_report_details_load'); ?>' + "/" + ids,
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 style="text-align: center">Daiyly Medicin Sells Report</h3>
    </div>
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" class="btn btn-primary " onclick="daily_medicin_sell_report_details_load()" value="Search"></td>
            </tr>
        </table>   
