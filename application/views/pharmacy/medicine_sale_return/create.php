...
<script type="text/javascript">
    ...
    function patient_data_set(search_parameter) {
    $('#img').show();
    ...
    xhttp.onreadystatechange = function() {
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            } else if (patient_array[0] == 'opd_patient') {
    ...
    xhttp.open("POST", "<?php echo site_url('MedicineSaleReturnWithoutInvoiceController/patient_data_load_by_name_unique_id'); ?>", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send("search_parameter=" + encodeURIComponent(search_parameter));
}
    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#medicine_sale_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('MedicineSaleReturnWithoutInvoiceController/medicine_sale_return_save'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Medinice Sale Return Without Invoice</h3>
        </div>
            ...
            <form id="medicine_sale_form" method="POST" class="form">
                <div class="container-fluid">
                    <div class="col-sm-12 col-md-12 main">
                        <?php
                        $uniqu_id = $this->db->select('*')->order_by('medicine_sale_return_invoice_id', 'DESC')->limit('1')->get('medicine_sale_return_invoices_without_invoice')->row();
                        $return_invoice_no = 'RI' . time() . '0' . (intval($uniqu_id->id_serial ?? 0) + 1);
                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input readOnly="" type="text" required="" value="<?php echo date('d-m-Y'); ?>" class="form-control" id="return_date" name="return_date">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly="" class="form-control" value="<?php echo $return_invoice_no ?>" id="return_invoice_no" name="return_invoice_no">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="clear: left;margin-top:5px" class="table-responsive">
                            ...
                            <table style="margin-top:5px;float:right;width:60%">
                                ...
                                <tr>
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Return Amount:&nbsp;</b>
                                        <input readonly type="text" name="return_amount" id="return_amount" required="" class="form-control" style="width:200px;float: right;" value="">
                                    </td>
                               
                                    <td align="right" style="padding:5px;">
                                        <b>Return Reference</b>
                                        <input placeholder="Enter Return Reference" type="text" name="return_reference" id="return_reference" class="form-control" style="width:200px;float: right;">
