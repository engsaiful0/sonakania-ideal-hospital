<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#expired_medicine_form").validate({
            ...
            messages: {
                date: "Enter date",
                drug_type_id: "Please select a type name",
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#expired_medicine_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('ExpiredMedicineController/expired_medicine_edit_save'); ?>",
                    data: formData,
                    dataType: "json",
    ...
    function getdrugdetails(element, e) {
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                var stock = msg.stock;
                var purchase_rate = msg.purchase_rate;
                var shelf = msg.shelf;
                var group_name = msg.group_name;
                var wsr = msg.wsr;
                $("#mrp_rate" + seq).val(sales_rate);
                $("#purchase_rate" + seq).val(purchase_rate);
                $("#quantity" + seq).focus();
            }
        });
    }
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Edit Expire Medicine</h3>
        </div>
        <div class="panel-body">
            <form id="expired_medicine_form" method="POST" class="form">
                <?php
                $expired_medicines = $this->db->where('expired_medicine_id', $expired_medicine_id)->get('expired_medicines')->row();
                ?>
                <input type="hidden" class="form-control" value="<?php echo $expired_medicine_id ?>" id="expired_medicine_id" name="expired_medicine_id">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required="" value="<?php echo date('d-m-Y', strtotime($expired_medicines->date)); ?>" class="form-control" id="datepicker" name="date">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="name">Expre No</label>
                            <div class="col-sm-8">
                                <input type="text" readonly="" class="form-control" value="<?php echo $expired_medicines->expired_medicine_invoice_no ?>" id="expired_medicine_invoice_no" name="expired_medicine_invoice_no">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php echo $expired_medicines->remarks ?>
                                </textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding:5px;">
                                ...
                                <table width="100%" class="table-responsive table table-bordered table-striped " id="cart_tab1">
                                    ...
                                    ?>
                                    <input type="hidden" value="<?php echo count($expired_medicine_details) ?>" name="id_control" id="id_control" class="form-control">
                                    <?php
                                    $seq = 0;
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:5px;">
                                                <input type="hidden" id="drug_id_value<?php echo $seq ?>" value="<?php echo $expired_medicine_value->drug_id ?>" readonly name="drug_id_value[]" class="form-control" ">
                                            ...
                                            <td>
                                                <input type=" text" readonly id="purchase_rate<?php echo $seq ?>" value="<?php echo $expired_medicine_value->purchase_rate ?>" name="purchase_rate[]" class="form-control" sequence=0>
                                            </td>
                                            <td>
                                                <input type="text" readonly id="mrp_rate<?php echo $seq ?>" value="<?php echo $expired_medicine_value->mrp_rate ?>" name="mrp_rate[]" class="form-control" sequence=0>
                                            </td>


                                            <td>
                                                <input type="text" id="quantity<?php echo $seq ?>" value="<?php echo $expired_medicine_value->quantity ?>" name="quantity[]" oninput="validateIntegerInput(this)" class="form-control" sequence=0 required="" onkeyup="getamount(this, event)">
                                            </td>


                                            <td>
                                                <input type="text" id="amount<?php echo $seq ?>" name="amount[]" value="<?php echo $expired_medicine_value->amount ?>" class="form-control amount" readonly="" sequence=0>
                                            </td>
                                            <?php
                                            if ($seq == 0) {
                                            ?>
                                            ...
                                            ?>
                                                <td style="padding:5px;">
                                                    <button class="btn btn-danger  btn-xs remove" type="button" onclick="removetr(this, event)" sequence=<?php echo $seq ?>><i class="glyphicon glyphicon-remove"></i></button>
                                                </td>
                                            <?php
                                            }
                                            ?>
                                ...
                                <table style="margin-top:5px;float:right">
                                    <tr>
                                        <td colspan="" valign="middle" style="padding:5px;">
                                            <b>Total:&nbsp;</b>
                                            <input type="text" readonly="" name="total"  id="total" class="form-control" style="width:200px;float: right;" value="<?php echo $expired_medicines->total ?>">
                                        </td>
                                    </tr>
