...
<div id="report">
    ...
    <table border="0">
        <tr>
            <td style="font-weight: bold;">Supplier</td><td><b><?= $supplier->name ?></b></td>
            <td style="font-weight: bold;">Status</td><td><b><?= $medicine_purchase->status ?></b></td>
        </tr>
        <tr>
            <td style="font-weight: bold;">Invoice No</td><td><?= $medicine_purchase->medicine_purchase_invoice_no ?></td>
            <td style="font-weight: bold;">Date</td><td><?= date('d-m-Y', strtotime($medicine_purchase->date)) ?></td>
        </tr>
    </table>
