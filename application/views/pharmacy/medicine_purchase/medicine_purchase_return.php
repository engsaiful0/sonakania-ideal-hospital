    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#medicine_purchase_return_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('MedicinePurchaseReturnController/medicine_purchase_return_save'); ?>",
                    data: formData,
                    dataType: "json",
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" readonly="" class="form-control" value="<?php echo $medicine_purchase_return_invoice_no ?>" id="medicine_purchase_return_invoice_no" name="medicine_purchase_return_invoice_no">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="padding:5px;">
                                                        ...
                                                        <input type="hidden" value="<?php echo $value_de->quantity ?>" id="purchase_quantity<?php echo $seq ?>" name="purchase_quantity[]" class="form-control"" onkeyup=" getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>
                                                    <td style="padding:5px;">
                                                        <input type="text" id="return_quantity<?php echo $seq ?>" oninput="validateIntegerInput(this)" name="return_quantity[]" class="form-control" required="" onkeyup="getamount(this, event)" sequence=<?php echo $seq ?>>
                                                    </td>
