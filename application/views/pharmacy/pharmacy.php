    ...
    <?php if (in_array('pharmacy_dashboard', $permissions)) { ?>
        ...
        <div class="panel panel-primary" style="width: 100%; margin: 0 auto;">
            <div class="panel-heading">
                <h3 style="text-align: center;">Pharmachy Dashboard</h3>
            </div>
            <div class="panel-body">
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Sell Due</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                ...
                <fieldset>
                    ...
                    $total_medicine_sale_amount_month = $this->db->select_sum('nettotal')
                        ->where('bill_date >=', $first_day_of_month)
                        ->where('bill_date <=', $last_day_of_month)
                        ->get('medicine_sales')
                        ->row()
                        ->nettotal;

                    // Fetch the sum of the amount from the medicine_purchase table for the current month
                    $total_medicine_purchase_amount_month = $this->db->select_sum('nettotal')
                    ...
                    // Fetch the sum of the due amount from the medicine_sales table for the current month
                    $total_sale_due_amount_month = $this->db->select_sum('due')
                        ->where('bill_date >=', $first_day_of_month)
                        ->where('bill_date <=', $last_day_of_month)
                        ->get('medicine_sales')
                        ->row()
                    ...
                    // Fetch the sum of the due amount from the medicine_purchase table for the current month
                    $total_medicine_purchase_due_amount_month = $this->db->select_sum('due')
                        ->where('date >=', $first_day_of_month)
                        ->where('date <=', $last_day_of_month)
                        ->get('medicine_purchase')
                        ->row()
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_medicine_sale_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_medicine_purchase_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large"><i class="fas fa-ticket-alt"></i></div>
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Sell Due Amount</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_sale_due_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-orange-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="card-icon card-icon-large"><i class="fas fa-dollar-sign"></i></div>
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Purcahse Due Amount</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_medicine_purchase_due_amount_month);
                                            ?>
                                        </h2>
                                    </div>
                ...
                <fieldset>
                    ...
                    $total_medicine_sale_amount_year = $this->db->select_sum('nettotal')
                        ->where('bill_date >=', $first_day_of_year)
                        ->where('bill_date <=', $last_day_of_year)
                        ->get('medicine_sales')
                        ->row()
                        ->nettotal;

                    // Fetch the sum of the amount from the medicine_purchase table for the current year
                    $total_medicine_purchase_amount_year = $this->db->select_sum('nettotal')
                    ...
                    $total_sale_due_amount_year = $this->db->select_sum('due')
                        ->where('bill_date >=', $first_day_of_year)
                        ->where('bill_date <=', $last_day_of_year)
                        ->get('medicine_sales')
                        ->row()
                    ...
                    $total_medicine_purchase_due_amount_year = $this->db->select_sum('due')
                        ->where('date >=', $first_day_of_year)
                        ->where('date <=', $last_day_of_year)
                        ->get('medicine_purchase')
                        ->row()
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_medicine_sale_amount_year);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_medicine_purchase_amount_year);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_sale_due_amount_year);
                                            ?>
                                        </h2>
                                    </div>
                        ...
                        <div class="card l-bg-orange-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php echo number_format($total_medicine_purchase_due_amount_year) ?>
                                        </h2>
                                    </div>
