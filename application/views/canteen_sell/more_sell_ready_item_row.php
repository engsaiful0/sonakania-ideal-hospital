<tr>
    <td>
        <select name="canteen_ready_item_id[]" class="form-control" id="canteen_ready_item_id_<?php echo $next_id ?>" onchange="unit_load(this.id)" sequence=0 required="" style="width:200px;">
    ...
    <td>
        <input  placeholder="Enter Quantity" type="text" value="" id="quantity<?php echo $next_id ?>" name="quantity[]" class="form-control" oninput="getamount(this, event)" sequence=<?php echo $next_id ?>>
    </td>
    <td>
    ...
    <td>
        <input  placeholder="Enter Unit Price" type="text" value="" id="price<?php echo $next_id ?>" name="price[]" class="form-control" oninput="getamount(this, event)" sequence=<?php echo $next_id ?> required="">
    </td>
