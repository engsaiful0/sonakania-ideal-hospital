<script>
    ...
    $(document).ready(function() {
        ...
        $("#journal_voucher_entry_form").validate({
            ...
            messages: {
                journal_account_id: "Please Select a journal account",
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#journal_voucher_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('JournalVoucherController/save_journal_voucher_data'); ?>",
                    data: formData,
                    dataType: "json",
...
<div class="container-fluid" style=" background-color: white;width: 98%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Add Journal Voucher</h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="journal_voucher_entry_form" class="form-horizontal" method="post" enctype='multipart/form-data'>
                        <?php
                        $journal_voucher = $this->db->select('*')
                            ->order_by('journal_voucher_invoice_id', 'DESC')
                            ->limit(1)
                            ->get('journal_voucher_invoices')
                            ->row();

                        if (!$journal_voucher) {
                            $journal_voucher = new stdClass();
                            $journal_voucher->journal_voucher_invoice_serial = 0; // Default value
                        }

                        $journal_voucher_no = 'JV' . time() . '0' . ($journal_voucher->journal_voucher_invoice_serial + 1);
                        ?>


                        <input type="hidden" readonly="" class="form-control" value="<?php echo $journal_voucher->journal_voucher_invoice_serial + 1 ?>" id="journal_voucher_invoice_serial" name="journal_voucher_invoice_serial">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly="" class="form-control" value="<?php echo $journal_voucher_no ?>" id="journal_voucher_no" name="journal_voucher_no">
                                    </div>
                                </div>
                            </div>
