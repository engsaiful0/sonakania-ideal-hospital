        ...
        <i class="fas fa-clipboard-check"></i> Test Result <span class="icon">+</span>
            <ul class="submenu">
                ...
                <?php if (in_array('add_panel_test_result', $permissions)) { ?>
                    <li><a class="box_a" href="<?php echo base_url() ?>add-panel-test">Add Panel Test</a></li>
                <?php } ?>
                <?php if (in_array('view_panel_test_result', $permissions)) { ?>
                    <li><a class="box_a" href="<?php echo base_url() . "index.php/TestPanelResultController/view_panel_test"; ?>">View Panel Test</a></li>
                <?php } ?>
