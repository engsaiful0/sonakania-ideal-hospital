<script>
    ...
    $(document).ready(function() {
        ...
        $('#emergency_data_entry_form').on('submit', function(e) {
            e.preventDefault();
            if (window.__emergencyEditSubmitting) {
                return false;
            }
            ...
            window.__emergencyEditSubmitting = true;
            ...
            $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('EmergencyController/update_emergency_data'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.__emergencyEditSubmitting = false;
    ...
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        ...
        <div class="panel-body">
            <form id="emergency_data_entry_form" action="" method="POST" class="form">
                ...
                <input type="hidden" class="form-control" id="discount_reference_director_id" name="discount_reference_director_id" value="<?php echo $emeergency->discount_reference_director_id ?>">
                <input type="hidden" class="form-control" id="discount_reference_doctor_id" name="discount_reference_doctor_id" value="<?php echo $emeergency->discount_reference_doctor_id ?>">
                <input type="hidden" class="form-control" id="discount_reference_employee_id" name="discount_reference_employee_id" value="<?php echo $emeergency->discount_reference_employee_id ?>">
                <input type="hidden" class="form-control" id="discount_reference_media_id" name="discount_reference_media_id" value="<?php echo $emeergency->discount_reference_media_id ?>">
                    ...
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?php echo date('Y-m-d', strtotime($emeergency->date)); ?>" id="datepicker" name="date" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" placeholder="Scan of Type Patient Id.." value="<?php echo $emeergency->patient_unique_id ?>" class="form-control" id="patient_unique_id" name="patient_unique_id">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="Enter Name" value="<?php echo $emeergency->name ?>" required="" id="name" name="name" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="Enter Phone" value="<?php echo $emeergency->phone ?>" id="phone" name="phone" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea placeholder="Enter Address" type="text" id="address" name="address" class="form-control"><?php echo $emeergency->address ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="Enter Attendant" value="<?php echo $emeergency->attendant ?>" id="attendant" name="attendant" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="emergency_invoice_no" name="emergency_invoice_no" class="form-control" readonly="" value="<?php echo $emeergency->emergency_invoice_no ?>" />
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="padding:5px;">
                                            <select name="emergency_service_id[]" class="form-control" id="emergency_service_id_<?php echo $id ?>" sequence=0 onchange="emergency_service_price_load(this.id)" required="" style="width:250px;">
                                        ...
                                        <td style="padding:5px;">
                                            <input type="text" value="<?php echo $emeergency_details_value->quantity ?>" id="quantity_0" name="quantity[]" oninput="getTotalAmount(this, event)" onkeydown="validateNumberInput(event)" class="form-control" sequence=0 onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)">
                                        </td>
                                        <td style="padding:5px;">
                                            <input type="text" value="<?php echo $emeergency_details_value->discounteach ?>" id="discounteach_0" name="discounteach[]" class="form-control" sequence=0 onkeyup="getamount(this, event)">
                                        </td>

                                        <td style="padding:5px;">
                                            <input type="text" value="<?php echo $emeergency_details_value->amount ?>" id="amount_0" name="amount[]" class="form-control amount" readonly="" sequence=0>
                                        </td>
                                        <?php
                                        if ($id == 0) {
                                        ?>
                            ...
                            <div class="row" style="margin-top:20px;">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select onchange="director_discount_load(this.value)" type="text" class="form-control" id="reference_director_id" name="reference_director_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select type="text" class="form-control" id="reference_doctor_id" name="reference_doctor_id">
                                                ...
                                                ?>
                                                    <option <?php echo $emeergency->reference_doctor_id == $doctor_value->doctor_id ? "selected" : "" ?> value="<?php echo $doctor_value->doctor_id ?>"><?php echo $doctor_value->doctor_name.' - '.$doctor_value->doctor_unique_id ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                    ...
                    <div style="width: 30%;float:left">
                        <table>
                            ...
                            <tr>
                                <td align="right" valign="middle" style="padding:5px;">
                                    <b>Total Discount:</b>
                                    <input type="text" name="total_discount" value="<?php echo $emeergency->total_discount ?>" id="total_discount" class="form-control" style="width:150px;float: right;" value="0">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="right" valign="middle" style="padding:5px;">
                                    <b>Paid:&nbsp;</b>
                                    <input type="text" name="paid" id="paid" value="<?php echo $emeergency->paid ?>" oninput="dueCal()" required="" class="form-control" style="width:150px;float: right;" value="">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="right" valign="middle" style="padding:5px;">
                                    <b>Due:&nbsp;</b>
                                    <input type="text" name="due" id="due_sale" value="<?php echo $emeergency->due ?>" readonly="" class="form-control" style="width:150px;float: right;" value="0">
                                </td>
                            </tr>
