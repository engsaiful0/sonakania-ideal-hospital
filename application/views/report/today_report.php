<script>
    function today_report_details_load() {
        ...
        window.open(
                '<?php echo site_url('ReportController/today_report_details_load'); ?>' + "/" + ids,
    ...
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" class="btn btn-primary " onclick="today_report_details_load()" value="Search"></td>
            </tr>
        </table>   

        <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img" style="display:none"/>
        <div id="today_report_details_load">
