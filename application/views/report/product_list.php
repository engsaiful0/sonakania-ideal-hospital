...
//        $total_product = $this->db->where('stock>', '0')->get('product');
         $total_product = $this->db->select('*')->get('product');
        ...
        $page_number_print = 1;
        // echo $total_students;
        $page_limit = ceil($total_products / 35);
        //echo $page_limit;
        $grand_stock = 0;
        $grand_mrp = 0;
                        ...
                        <table border="1" style="border-collapse: collapse;width: 100%; ">
                            ...
                            foreach ($product as $product_value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo $product_value->purchase_price;
                                        $grand_purchase_price += $product_value->purchase_price;
                                        ?>
                                    </td>
                                    <td>
                                        <?php
                                        echo $product_value->retail_sell_price;
                                        $grand_mrp += $product_value->retail_sell_price;
                                        ?>
                                    </td>
