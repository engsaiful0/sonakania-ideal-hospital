    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#salary_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('SalaryController/salary_data_save'); ?>",
                    data: formData,
                    dataType: "json",
        ...
        <div class="panel-body">
            ...
            <form id="salary_entry_form" method="POST" class="form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required="" value="<?php echo date('d-m-Y'); ?>" class="form-control" id="datepicker1" name="date">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($active_employees as $emp): ?>
                                            <tr data-gross="<?= $emp->gross_salary ?>">
                                                ...
                                                <td><input style="width: 50px;" type="text" class="form-control working_days" name="working_days[]"></td>
                                                <td><input type="text" class="form-control daily_salary" name="daily_salary[]" readonly></td>
                                                <td><input type="number" style="width: 50px;" class="form-control over_time" name="over_time[]" value=""></td>
                                                <td><input type="number" class="form-control ot_allowance" name="ot_allowance[]" value=""></td>
                                                <td><input type="number" class="form-control other_allowance" name="other_allowance[]" value=""></td>
                                                <td><input type="number" class="form-control total_salary" name="total_salary[]" value="" readonly></td>
                                                <td><input style="width: 50px;" type="number" class="form-control absent" name="absent[]" value=""></td>
                                                <td><input type="text" style="width: 50px;" class="form-control late_day" name="late_day[]"></td>
                                                <td><input type="number" class="form-control deduction" name="deduction[]" value=""></td>

                                                <td><input type="text" class="form-control payable" name="payable[]" readonly></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                ...
                <table style="margin-top:5px;float:right;width:60%">
                    ...
                    <tr>
                        <td>Net Payable</td>
                        <td> <input type="text" readonly="" name="net_payable" id="net_payable" class="form-control" value="0"></td>
