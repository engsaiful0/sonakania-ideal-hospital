    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#patient_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('DoctorSerialController/add_doctor_serial_save'); ?>",
                    data: formData,
                    dataType: "json",
...
<div class="container-fluid" style=" background-color: white;width: 98%;">
    ...
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Add Doctor Serial</h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input placeholder="Enter Patient Name" type="text" class="form-control" required="" id="patient_name" name="patient_name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php
                                        $uniqu_id = $this->db->select('*')->order_by('id', 'DESC')->limit('1')->get('doctor_serial_unique_table')->row();
                                        if (!$uniqu_id) {
                                            $uniqu_id = new stdClass();
                                            $uniqu_id->id_serial = 0; // Default value
                                        }
                                        $patient_unique_id = 'DS' . time() . '0'  . $uniqu_id->id_serial + 1;
                                        ?>
                                        <input type="hidden" readonly="" class="form-control" value="<?php echo $uniqu_id->id_serial + 1 ?>" id="id_serial" name="id_serial">
                                        <input type="text" readonly="" class="form-control" value="<?php echo $patient_unique_id ?>" id="doctor_serial_unique_id" name="doctor_serial_unique_id">
                        ...
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="visiting_time" value="<?php date_default_timezone_set('Asia/Dhaka');
                                                                                                            echo date("h:i:s A"); ?>" name="visiting_time">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top:20px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select type="text" required="" class="form-control" id="doctor_id" onchange="serial_load(this.value)" name="doctor_id">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label class="control-label col-sm-4" for="serial_numaber">Serial Number</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label class="control-label col-sm-4" for="datepicker">Entry Date</label>
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select type="text" class="form-control" id="reference_director_id" name="reference_director_id">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $share_holder->share_holder_id ?>"><?php echo $share_holder->name . '-' . $share_holder->unique_id ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
