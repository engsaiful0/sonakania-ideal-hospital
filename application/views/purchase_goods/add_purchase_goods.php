                    ...
                    <div class="table-responsive">
                        ...
                        <table width="100%" class="table">
                            <tr>
                                ...
                                <?php
                                error_reporting(0);
                                $purchase_goods_invoice = $this->db->select('*')->order_by('purchase_goods_invoice_id', 'DESC')->limit('1')->get('purchase_goods_invoice')->row();

                                $purchase_goods_invoice_no = 'PG' . time() . '0' . intval($purchase_goods_invoice->purchase_goods_invoice_serial) + 1;
                                ?>
                                <td align="left" style="padding:5px;width: 400px;">
                                    <input type="text" id="purchase_goods_invoice_no" name="purchase_goods_invoice_no" class="form-control" readonly="" value="<?php echo $purchase_goods_invoice_no; ?>" />
                                    <input type="hidden" id="purchase_goods_invoice_no" name="purchase_goods_invoice_serial" class="form-control" readonly="" value="<?php echo $purchase_goods_invoice->purchase_goods_invoice_serial + 1; ?>" />
                                </td>
                                <td width="100px;" align="right">
                                    <b>Date</b>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" style="padding:5px;">
                                    <select name="supplier_id" id="supplier_id" class="form-control" required="">
                                        ...
                                        <?php
                                        $sql = $this->db->select('*')->where('type', 'management_goods_supplier')->order_by('name', 'ASC')->get('supplier')->result();
                        ...
                        <table width="100%" border="0" id="cart_tab1">
                            ...
                            <tr>
                                <td>
                                    <select name="item_id[]" class="form-control" id="item_id_0" onchange="price_select(this.id)" sequence=0 required="" style="width:200px;">
                        ...
                        <table width="100%" class="table">
                            ...
                            <tr>
                                <td colspan="7" align="right" valign="middle" style="padding:5px;">
                                    <b>Discount:&nbsp;</b>
                                    <input type="text" name="discount" oninput="discount_cal()()" id="discount" class="form-control" style="width:200px;float: right;">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7" align="right" valign="middle" style="padding:5px;">
                                    <b>Total Discount:&nbsp;</b>
                                    <input type="text" name="total_discount" readonly id="total_discount" class="form-control" style="width:200px;float: right;">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7" align="right" valign="middle" style="padding:5px;">
