...
<body>
    ...
    <div id="report" style="width: 90%;margin:0 auto;margin-left:45px;;margin-top:50px;">
        ...
        <?php
        error_reporting(0);
        $total_director = $this->db->get('director');
        $total_rows = $total_director->num_rows();
                    ...
                    <div class="first">
                        <div class="second">
                            <table border="1" class="table table-bordered table-hover" style="width: 90%;margin: 0 auto;color:black;border-collapse:collapse;">
                                ...
                                <?php
                                $from = $from + 10;
                                $this->db->select('director.*,profession.name as profession_name'); // Select all columns from both tables or specify the required columns
                                $this->db->from('director'); // Base table
                                $this->db->join('profession', 'director.profession_id = profession.profession_id', 'left');
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $query_value->unique_id ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo $query_value->no_of_share ?>
                                        </td>
                                        <td>
                                    ...
                                    ?>
                                        <img style="height: 75px;width: 100px;" src="<?php echo base_url() ?>assets/director/<?php echo $data->picture ?>"></td>
                                    <?php
                                            }
                                    ?> </td>
