    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#canteen_ready_item_inventory_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('CanteenReadyItemInventoryController/update_canteen_ready_item_inventory'); ?>",
                    data: formData,
                    dataType: "json",
...
$canteen_ready_item_inventory_details = $this->db->where('canteen_ready_item_inventory_id', $canteen_ready_item_inventory_id)->get('canteen_ready_item_inventory_details')->result();
$id = 0;
?>
<div class="container-fluid">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Edit Daily Inverntory</h3>
        </div>
            ...
            <form id="canteen_ready_item_inventory_form" method="POST" class="form">
                <div class="col-sm-12 col-md-12 main">
                    <div class="table-responsive">
                        ...
                        ?>
                        <input name="canteen_ready_item_inventory_id" type="hidden" value="<?php echo $canteen_ready_item_inventory_id ?>">
                        <table width="100%" class="table">
                            <tr>
                                ...
                                <td align="left" style="padding:5px;">
                                    <input type="text" value="<?php echo date('d-m-Y', strtotime($canteen_ready_item_inventory->date)); ?>" id="date" name="date" class="form-control" readonly="" />
                                </td>
                                <td width="100px;" align="right">
                                    <b>Invoice</b>
                                </td>
                                <td align="left" style="padding:5px;">
                                    <input type="text" id="canteen_ready_item_inventory_invoice_no" name="canteen_ready_item_inventory_invoice_no" class="form-control" readonly="" value="<?php echo $canteen_ready_item_inventory->canteen_ready_item_inventory_invoice_no; ?>" />

                                </td>
                                <td width="100px;" colspan="" align="right"><b>Purpose</b></td>
                                <td align="left" style="padding:5px;">
                                    <textarea placeholder="Enter Purpose" type="text" id="purpose" name="purpose" class="form-control"><?php echo $canteen_ready_item_inventory->purpose ?></textarea>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" border="0" id="cart_tab1">
                            ...
                            foreach ($items as $item) {
                                ...
                                $canteen_ready_item_inventory_detail = $this->db
                                    ->where('canteen_ready_item_inventory_id', $canteen_ready_item_inventory_id)
                                    ->where('canteen_ready_item_id', $item->canteen_ready_item_id)
                                    ->get('canteen_ready_item_inventory_details')->row();
                            ?>
                                <tr>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        <input placeholder="Enter Quantity" type="number" value="<?php echo !empty($canteen_ready_item_inventory_detail) && !empty($canteen_ready_item_inventory_detail->quantity) ? $canteen_ready_item_inventory_detail->quantity : ''; ?>" id="quantity<?php echo  $serial ?>" name="quantity[]" class="form-control quantity" oninput="getamount(this, event)" sequence="<?php echo  $serial ?>">
                                    </td>

                                    <td>
                                        <input placeholder="Enter Unit Price" type="number" value="<?php echo !empty($canteen_ready_item_inventory_detail) && !empty($canteen_ready_item_inventory_detail->price) ? $canteen_ready_item_inventory_detail->price : ''; ?>" id="price<?php echo  $serial ?>" name="price[]" class="form-control" oninput="getamount(this, event)" sequence="<?php echo  $serial ?>" required="">
                                    </td>
                                    <td>
                                        <input type="number" placeholder="Total Amount" value="<?php echo !empty($canteen_ready_item_inventory_detail) && !empty($canteen_ready_item_inventory_detail->total_amount) ? $canteen_ready_item_inventory_detail->total_amount : ''; ?>" id="total_amount<?php echo  $serial ?>" name="total_amount[]" class="form-control amount" readonly="" sequence="<?php echo  $serial ?>" required="">
                                    </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <input readonly class="form-control" value="<?php echo $canteen_ready_item_inventory->grand_total_quantity ?>" name="grand_total_quantity" id="grand_total_quantity">
                                </td>
                                <td></td>
                                <td>
                                    <input readonly class="form-control" value="<?php echo $canteen_ready_item_inventory->grand_total_amount ?>" name="grand_total_amount" id="grand_total_amount">
                                </td>
                            </tr>
                            <tr>
