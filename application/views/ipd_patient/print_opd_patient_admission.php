...
<p style="font-size: 20px;font-weight: bold;text-align: center "><?php echo $department->department_name ?></p>
    <table border="1" style="width: 100%;border-collapse:collapse;margin:0 auto;color:black">
        ...
        <tr>
            ...
            <td>
    <b>
        <?php echo $opd_patient->age_year . ' ' . ($opd_patient->age_year == 1 ? 'Year' : 'Years'); ?>
        <?php echo $opd_patient->age_month . ' ' . ($opd_patient->age_month == 1 ? 'Month' : 'Months'); ?>
        <?php echo $opd_patient->age_day . ' ' . ($opd_patient->age_day == 1 ? 'Day' : 'Days'); ?>
    </b>
</td>
