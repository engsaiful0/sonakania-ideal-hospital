                                    ...
                                    <div class="col-sm-8">
                                        <div style="width: 50%;float:left">
                                            <select style="width: 100%;" type="text" onchange="bed_number_load(this.value)" class="form-control" id="ward_id" name="ward_id">
                                                ...
                                                <?php
                                                $wards = $this->db->select('*')->get('word')->result();
                        ...
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="" value="<?php echo date('d-m-Y') ?>" name="date">
                        ...
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text"  class="form-control" id="admission_time" value="<?php date_default_timezone_set('Asia/Dhaka');
                                                                                                                    echo date("h:i:s A"); ?>" name="admission_time">
                                    </div>
                                </div>
                            </div>
                        </div>
