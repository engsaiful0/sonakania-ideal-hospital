    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#increment_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('IncrementController/save_increment_data'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {                            
                            ...
                            window.location.href = "<?php echo base_url('add-increment') ?>";
                        } else {
...
<div class="container-fluid" style=" background-color: white;width: 98%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Add Increment</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" oninput="validateInputFloatingPoint(this)" class="form-control" placeholder="Enter Increment Amount" id="amount" name="amount">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea type="text" class="form-control" placeholder="Enter Remark" value="" id="remark" name="remark"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
