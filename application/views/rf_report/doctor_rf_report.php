<script>
    function doctor_rf_report_load() {
        ...
        window.open(
                '<?php echo site_url('ReportRfController/doctor_rf_report_details_load'); ?>' + "/" + ids,
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 style="text-align: center">Doctor RF Report</h3>
    </div>
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" class="btn btn-primary " onclick="doctor_rf_report_load()" value="Search"></td>
            </tr>
        </table>   

        <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img" style="display:none"/>
        <div id="doctor_rf_report_load">
