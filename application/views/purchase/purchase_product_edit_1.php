<script type="text/javascript">
    function model_load(product_category_id)
    {
        ...
        var id_no = product_category_id.split("_");
        var product_category_id = $('#product_category_id_' + id_no[3]).val();

        //alert(product_category_id);
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                document.getElementById("model_id_" + id_no[3]).innerHTML = xhttp.responseText;
                $('#img').hide();
            }
        }
    ...
    function color_load(model_id)
    {
        $('#img').show();
        var id_no = model_id.split("_");
        var model_id = $('#model_id_' + id_no[2]).val();

        //alert(id_no);
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                document.getElementById("color_id_" + id_no[2]).innerHTML = xhttp.responseText;
                $("#color_id_" + id_no[2]).prop("multiple");
                $("#color_id_" + id_no[2]).multiselect();
                $('#img').hide();
            }
        }
        //  alert(xhttp.responseText);
        xhttp.open("POST", "<?php echo site_url('ProductController/color_load_for_edit'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        //            xhttp.send("fname=Henry&lname=Ford");
        xhttp.send("model_id=" + model_id);
    }
    function stock_message(color_id)
    {
        $('#img').show();
        var id_no = color_id.split("_");
        var color_id = $('#color_id_' + id_no[2]).val();
        var model_id = $('#model_id_' + id_no[2]).val();
        var product_category_id = $('#product_category_id_' + id_no[2]).val();

        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                var data_array = xhttp.responseText.split("_");
                document.getElementById("stock_message").innerHTML = data_array[0];/*retail price*/
                document.getElementById("product_id_" + id_no[2]).value = data_array[1];/*product id*/
        ...
        //                    alert(xhttp.responseText);
        xhttp.open("POST", "<?php echo site_url('WholeSellController/stock_message'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        //            xhttp.send("fname=Henry&lname=Ford");
        xhttp.send("product_category_id=" + product_category_id + "&color_id=" + color_id + "&model_id=" + model_id);
    }
    function prodcut_id(color_id)
    {
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                var data_array = xhttp.responseText.split("_");
                document.getElementById("purchase_unit_price_" + id_no[2]).value = data_array[0];/*mrp*/
                document.getElementById("product_id_" + id_no[2]).value = data_array[1];/*product id*/
                $('#img').hide();
                //  document.getElementById("stock_" + id_no[2]).value = data_array[1];/*stock*/
            }
        ...
        //                    alert(xhttp.responseText);
        xhttp.open("POST", "<?php echo site_url('PurchaseController/prodcut_id'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        //            xhttp.send("fname=Henry&lname=Ford");
        xhttp.send("product_category_id=" + product_category_id + "&color_id=" + color_id + "&model_id=" + model_id);
...
<script>
    $(document).ready(function () {
        ...
        for (var i = 2; i <= id; i++)
        {
            $('#product_category_id_' + i).select2();
            $('#model_id_' + i).select2();

        }
// alert();
        $('#product_category_id_1').select2();
        $('#model_id_1').select2();
...
//                    $('#color_id_' + i).select2();
        ...
        xhttp.open("POST", "<?php echo site_url('PurchaseController/load_product_lsit'); ?>", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        //            xhttp.send("fname=Henry&lname=Ford");
        xhttp.send("id=" + id);
    }
