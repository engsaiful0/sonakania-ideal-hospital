    ...
    <?php if (in_array('marketting_dashboard', $permissions)) { ?>
        ...
        <div class="panel panel-primary" style="width: 100%; margin: 0 auto;">
            <div class="panel-heading">
                <h3 style="text-align: center;">Marketting</h3>
            </div>
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    $total_opd_patient = $this->db->select('COUNT(*) as total')
                        ->get('opd_patient')
                        ->row()
                        ->total; // Access the 'total' property directly here

                    $total_ipd_patient = $this->db->select('COUNT(*) as total')
                        ->get('ipd_patient')
                        ->row()
                        ->total;
                    $total_patients = $total_opd_patient + $total_ipd_patient;

                    $total_director =  $this->db->select('COUNT(*) as total')
                        ->get('director')
                        ->row()
                        ->total;

                    $total_employee =  $this->db->select('COUNT(*) as total')
                        ->get('employee')
                        ->row()
                        ->total;

                    $total_doctor =  $this->db->select('COUNT(*) as total')
                        ->get('doctor')
                        ->row()
                        ->total;
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_patients);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_employee);
                                            ?>
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Director</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_director);
                                            ?>
                                        </h2>
                                    </div>
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                            <?php
                                            echo number_format($total_doctor);
                                            ?>
                                        </h2>
                                    </div>
