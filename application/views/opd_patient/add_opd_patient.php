                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" id="patient_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="visiting_time" value="<?php date_default_timezone_set('Asia/Dhaka'); echo date("h:i:s A"); ?>" name="visiting_time">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top:20px;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input required type="text" oninput="validateInputFloatingPoint(this)" placeholder="Visiting Fee" class="form-control" id="visiting_fee" name="visiting_fee">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="clear:left">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label class="control-label col-sm-4" for="payable">Payable</label>
                                    <div class="col-sm-8">
