            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" id="patient_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row" style="clear:left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select type="text" required="" class="form-control" id="doctor_id" onchange="visiting_fee_load(this.value), serial_load(this.value)" name="doctor_id">
                                            ...
                                            ?>
                                                <option <?php echo $opd_patient->doctor_id == $doctor_value->doctor_id ? "selected" : "" ?> value="<?php echo $doctor_value->doctor_id ?>"><?php echo $doctor_value->doctor_name.' - '.$doctor_value->doctor_unique_id ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input required oninput="validateInputFloatingPoint(this)" type="text" class="form-control" id="visiting_fee" value="<?php echo $opd_patient->visiting_fee ?>" name="visiting_fee">
                                    </div>
                        ...
                        <div class="row" style="clear:left;margin-top:10px;" style="">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select type="text" class="form-control" id="reference_doctor_id" name="reference_doctor_id">
                                                ...
                                                ?>
                                                    <option <?php echo $doctor_value->doctor_id == $opd_patient->reference_doctor_id ? 'selected' : '' ?> value="<?php echo $doctor_value->doctor_id ?>"><?php echo $doctor_value->doctor_name.' - '.$doctor_value->doctor_unique_id ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
