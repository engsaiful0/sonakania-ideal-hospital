<script>
    function bank_deposit_report_details_load() {
        ...
        window.open(
                '<?php echo site_url('BankController/bank_deposit_report_details'); ?>' + "/" + ids,
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 style="text-align: center">Bank Deposit Report</h3>
    </div>
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" onclick="bank_deposit_report_details_load()" class="btn btn-primary" value="Search"></td>
            </tr>
        </table>   

        <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img" style="display:none"/>
        <div id="bank_deposit_report_details_load">
