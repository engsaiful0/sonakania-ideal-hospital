                    ...
                    <div class="first">
                        <div class="second">
                            <table border="1" style="width: 90%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 40px;">
                                <tr>
                                    <td colspan="5" style="text-align: center">Cash Deposited From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                                </tr>
                                <tr>
                                    <td>Sl</td>
                                    <td>Bank Name</td>
                                ...
                                foreach ($query as $query_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $grand_total_deposit += $query_value->amount;
                                            ?>
                                        </td>
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($grand_total_deposit, 0) ?></td>
                                    <td></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="second">
                            <table border="1" style="width: 90%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 40px;">
                                ...
                                foreach ($query as $query_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo $query_value->amount;
                                            $grand_total_withdraw += $query_value->amount;
                                            ?>
                                        </td>
                                        <td>
                                            <?php echo date('d-m-Y', strtotime($query_value->date)) ?>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="" style="text-align: right ">Total</td>
                                    <td><?php echo number_format($grand_total_withdraw, 0) ?></td>
                                    <td></td>
                                </tr>
                            </table>
                        </div>
            ...
            <page size="A4">
                <div class="first">
                    <div class="second">
                        <table border="1" style="width: 90%;border-collapse:collapse;margin:0 auto;color:black;margin-top: 40px;">
                            <tr>
                                <td colspan="6" style="text-align: center">Bank Balance Report From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                            </tr>
                             <tr>
                                <td>Sl</td>
                                <td>Description</td>
                            ...
                            <tr>
                                ...
                                <td>Total</td>
                                <td><?php echo number_format($grand_total_deposit-$grand_total_withdraw, 0) ?></td>
