<tr id="tr_<?php echo $id ?>" style="margin-top:3px;">
    ...
    <td style="width: 20%;">
        <select name="type_name[]" class="form-control" id="type_name_id_<?php echo $id ?>" onchange="drug_name_load(this.id)" required="" style="width:150px;">
    ...
    <td  style="width: 15%;">
        ...
        <input type="text" required="" style="width: 100%" class="form-control"  id="days_<?php echo $id ?>" placeholder="Days" name="days[]">
    </td>
    <td  style="width: 15%;">
