    ...
    $(document).ready(function() {
        ...
        $('#submit_button').click(function(e) {
            ...
            if ($("#phygiotherapy_data_entry_form").valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('phygiotherapyController/save_phygiotherapy_due_payment_data'); ?>",
                    data: formData,
                    dataType: "json",
...
<script type="text/javascript">
    ...
    function calculateDueAfterPayment() {
        var currentDue = <?php echo $phygiotherapy->due ?? 0; ?>;
        var duePayment = $("#due_payment").val() * 1;
        
        if (duePayment > currentDue) {
            alert('Due payment amount cannot be greater than the current due amount');
            $('#due_payment').val(currentDue);
            $('#due_sale').val(0);
        } else {
            var remainingDue = currentDue - duePayment;
            $("#due_sale").val(remainingDue.toFixed(2));
        }
    }
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" readonly value="<?php echo date('Y-m-d'); ?>" id="due_payment_date" name="due_payment_date" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input readonly type="text" value="<?php echo date('Y-m-d', strtotime($phygiotherapy->date)); ?>" id="datepicker" name="date" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input readonly type="text" placeholder="Scan of Type Patient Id.." value="<?php echo $phygiotherapy->patient_unique_id ?>" class="form-control" id="patient_unique_id" name="patient_unique_id">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input readonly type="text" placeholder="Enter Name" value="<?php echo $phygiotherapy->name ?>" required="" id="name" name="name" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input readonly type="text" placeholder="Year" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $phygiotherapy->age_year ?>" id="age_year" name="age_year">
                                </div>
                                <div class="col-sm-3">
                                    <input readonly type="text" placeholder="Month" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $phygiotherapy->age_month ?>" id="age_month" name="age_month">
                                </div>
                                <div class="col-sm-3">
                                    <input readonly type="text" placeholder="Day" oninput="validateIntegerInput(this)" class="form-control" value="<?php echo $phygiotherapy->age_day ?>" id="age_day" name="age_day">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input readonly type="text" oninput="validatePhoneNumberInput(this)" placeholder="Enter Phone" value="<?php echo $phygiotherapy->phone ?>" id="phone" name="phone" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea disabled placeholder="Enter Address" type="text" id="address" name="address" class="form-control"><?php echo $phygiotherapy->address ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input readonly type="text" placeholder="Enter Attendant" value="<?php echo $phygiotherapy->attendant ?>" id="attendant" name="attendant" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input readonly type="text" id="phygiotherapy_invoice_no" name="phygiotherapy_invoice_no" class="form-control" readonly="" value="<?php echo $phygiotherapy->phygiotherapy_invoice_no ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select disabled type="text" class="form-control" id="reference_doctor_id" name="reference_doctor_id">
                                        ...
                                        ?>
                                            <option <?php echo $phygiotherapy->reference_doctor_id == $doctor_value->doctor_id ? "selected" : "" ?> value="<?php echo $doctor_value->doctor_id ?>"><?php echo $doctor_value->doctor_name ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <table>
                                            ...
                                            ?>
                                                <tr>
                                                    <td style="padding:5px;">
                                                        <select disabled name="phygiotherapy_service_id[]" class="form-control" id="phygiotherapy_service_id_<?php echo $id ?>" sequence=<?php echo $id ?> onchange="phygiotherapy_service_price_load(this.id)" required="" style="width:150px;">
                                                    ...
                                                    <td style="padding:5px;">
                                                        <input readonly type="text" value="<?php echo $phygiotherapy_details_value->quantity ?>" onkeydown="validateNumberInput(event)" id="quantity_<?php echo $id ?>" name="quantity[]" oninput="getTotalAmount(this, event)" class="form-control" sequence=<?php echo $id ?> onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)">
                                                    </td>
                                                    <td style="padding:5px;">
                                                        <input readonly type="text" value="<?php echo $phygiotherapy_details_value->discounteach ?>" onkeydown="validateNumberInput(event)" id="discounteach_<?php echo $id ?>" name="discounteach[]" class="form-control" sequence=<?php echo $id ?> onkeyup="getamount(this, event)">
                                                    </td>

                                                    <td style="padding:5px;">
                                                        <input readonly type="text" value="<?php echo $phygiotherapy_details_value->amount ?>" id="amount_<?php echo $id ?>" name="amount[]" class="form-control amount" readonly="" sequence=<?php echo $id ?>>
                                                    </td>
                                                    <?php
                                                    if ($id == 0) {
                                                    ?>
                                ...
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Total:&nbsp;</b>
                                        <input readonly type="text" readonly="" value="<?php echo $phygiotherapy->total ?>" name="total" id="total" class="form-control" style="width:200px;float: right;" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Discount(%):&nbsp;</b>
                                        <input readonly type="text" name="discount" value="<?php echo $phygiotherapy->discount ?>" id="discount" class="form-control" style="width:200px;float: right;" value="0" onkeyup="totalamount()">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Dis. Reference</b>
                                        <input readonly type="text" style="width:200px;float: right;" class="form-control" value="<?php echo $phygiotherapy->discount_reference ?>" id="discount_reference" placeholder="Enter Discount Ref.." name="discount_reference">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Net Total:&nbsp;</b>
                                        <input readonly type="text" readonly="" name="nettotal" value="<?php echo $phygiotherapy->nettotal ?>" id="nettotal" class="form-control" style="width:200px;float: right;" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Paid:&nbsp;</b>
                                        <input readonly type="text" name="paid" id="paid" value="<?php echo $phygiotherapy->paid ?>" oninput="dueCal()" required="" class="form-control" style="width:200px;float: right;" value="">
                                    </td>
                                </tr>
                                <tr style="background-color:#006ADC;color:black">
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Due Payment:&nbsp;</b>
                                        <input type="text" name="due_payment" autofocus id="due_payment" value="<?php echo $phygiotherapy->due ?>" class="form-control" style="width:150px;float: right;" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Due:&nbsp;</b>
                                        <input type="text" name="due" id="due_sale" value="0" readonly="" class="form-control" style="width:200px;float: right;">
                                    </td>
                                </tr>
