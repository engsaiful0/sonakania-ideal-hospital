<script>
    ...
    $(document).ready(function() {
        ...
        // Validate the form
        $("#phygiotherapy_data_return_entry_form").validate({
            rules: {
        ...
        $('#submit_button').click(function(e) {
            ...
            var submitBtn = $(this);
            var formData = $('#phygiotherapy_data_return_entry_form').serialize();

            // Check if the form is valid
            if ($("#phygiotherapy_data_return_entry_form").valid()) {
                $('#phygiotherapy_data_return_entry_form :input').prop('disabled', true);
                submitBtn.prop('disabled', true).html('<i class="fa fa-spinner fa-spin"></i> Loading...');

                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('phygiotherapyController/phygiotherapy_return_data_save'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#phygiotherapy_data_return_entry_form')[0].reset();
                            $('#phygiotherapy_data_return_entry_form :input').prop('disabled', false);
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Return Physiotherapy</h3>
            <?php
        ...
        <div class="panel-body">
            <form id="phygiotherapy_data_return_entry_form" action="" method="POST" class="form">
                    ...
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input readonly type="hidden" class="form-control" id="ipd_patient_id" name="ipd_patient_id" value="<?php echo $phygiotherapy->ipd_patient_id ?>">
                                    <input readonly type="text" onblur="patient_data_set(this.value)" placeholder="Scan of Type Patient Id.." value="<?php echo $phygiotherapy->patient_unique_id ?>" class="form-control" id="patient_unique_id" name="patient_unique_id">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea readonly placeholder="Enter Address" type="text" id="address" name="address" class="form-control"><?php echo $phygiotherapy->address ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <table>
                                <tr>
                                    ...
                                    <td colspan="4" style="padding:5px;">
                                        ...
                                        <table width="100%" class="table-responsive table table-bordered table-striped " id="cart_tab1">
                                            ...
                                            <input readonly type="hidden" value="<?php echo count($phygiotherapy_details) ?>" name="id_control" id="id_control" class="form-control">
                                            <?php
                                            $id = 0;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="padding:5px;">
                                                        <input readonly readonly type="text" value="<?php echo $phygiotherapy_details_value->price ?>" id="price_<?php echo $id ?>" name="price[]" class="form-control" sequence=<?php echo $id ?> required="" onkeyup="getamount(this, event)">
                                                    </td>
                                                    <td style="padding:5px;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td> <input disabled type="button" onclick="addMore()" type="button" id="add_more" style="width:50px" id="add_more_<?php echo $id ?>" title="Click TO Remove" value="+"></td>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <td><input disabled type="button" onclick="removetr(this, event)" style="width:50px" readonly id="add_more_<?php echo $id ?>" title="Click TO Remove" value="-">
                                ...
                                <tr>
                                            ...
                                            <div class="row" style="clear:left;margin-top:10px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input required readonly value="<?php echo (float)$phygiotherapy->paid + (float)$phygiotherapy->due_payment - (float)$phygiotherapy->returnable_amount ?>" type="text" class="form-control" placeholder="Returnable Amount" id="returnable_amount" name="returnable_amount">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    <td colspan="2" align="right" valign="middle" style="padding:5px;">
                                        <b>Total:&nbsp;</b>
                                ...
                                <tr>
                                    <td colspan="2" align="right" valign="middle" style="padding:5px;">
                                        <b>Paid:&nbsp;</b>
                                        <input readonly type="text" name="paid" id="paid" value="<?php echo $phygiotherapy->paid+ (float)$phygiotherapy->due_payment - (float)$phygiotherapy->returnable_amount ?>" oninput="dueCal()" required="" class="form-control" style="width:200px;float: right;" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="right" valign="middle" style="padding:5px;">
                                        <b>Due:&nbsp;</b>
                                        <input readonly type="text" name="due" id="due_sale" value="<?php echo $phygiotherapy->due ?>" readonly="" class="form-control" style="width:200px;float: right;" value="0">
                                    </td>
                                </tr>
