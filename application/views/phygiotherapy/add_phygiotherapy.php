<script>
    ...
    $(document).ready(function() {
        ...
        $('#phygiotherapy_service_id_0').select2();
    ...
    $(document).ready(function() {
        ...
        $('#phygiotherapy_data_entry_form').on('submit', function(e) {
            e.preventDefault();
            if (window.__phygioAddSubmitting) {
                return false;
            }
            ...
            window.__phygioAddSubmitting = true;
            ...
            $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('PhygiotherapyController/save_phygiotherapy_data'); ?>",
                    data: formData,
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.__phygioAddSubmitting = false;
        ...
        $(document).keydown(function(e) {
            // Check if the key pressed is the plus sign and also if Shift key is pressed
            if (e.keyCode == 187 && e.shiftKey) {
                alert("Shift + + shortcut pressed!");
                // Perform any action you want for the shortcut
            }
        });
    });
</script>
...
<div class="container-fluid" style=" background-color: white;width: 100%;">
    <div class="panel panel-primary" style="width: 100%;margin: 0 auto">
        <div class="panel-heading">
            <h3 style="text-align: center">Add Physiotherapy</h3>
        </div>
        <div class="panel-body">
            ...
            <form id="phygiotherapy_data_entry_form" action="" method="POST" class="form">
                <fieldset style="background-color:whitesmoke;">
                    ...
                    <?php
                    error_reporting(0);
                    $phygiotherapy_invoice = $this->db->select('*')->order_by('phygiotherapy_invoice_id', 'DESC')->limit('1')->get('phygiotherapy_invoice')->row();
                    $phygiotherapy_invoice_no = 'Ph' . time() . '0' . $phygiotherapy_invoice->phygiotherapy_invoice_serial + 1;
                    ?>
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="physiotherapy_time">Time </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="physiotherapy_time" value="<?php date_default_timezone_set('Asia/Dhaka');
                                                                                                            echo date("h:i:s A"); ?>" name="physiotherapy_time">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" placeholder="Scan of Type Patient Id.." class="form-control" id="patient_unique_id" name="patient_unique_id">
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" oninput="validatePhoneNumberInput(this)" placeholder="Enter Phone" id="phone" name="phone" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="hidden" id="phygiotherapy_invoice_serial" name="phygiotherapy_invoice_serial" class="form-control" readonly="" value="<?php echo $phygiotherapy_invoice->phygiotherapy_invoice_serial + 1 ?>" />
                                    <input type="text" id="phygiotherapy_invoice_no" name="phygiotherapy_invoice_no" class="form-control" readonly="" value="<?php echo $phygiotherapy_invoice_no ?>" />
                ...
                <div class="container-fluid">
                    ...
                    <table width="100%" class="table-responsive table table-bordered table-striped " id="cart_tab1">
                        ...
                        <tr>
                            ...
                            <td style="padding:5px;">
                                <select name="phygiotherapy_service_id[]" class="form-control" id="phygiotherapy_service_id_0" sequence=0 onchange="phygiotherapy_service_price_load(this.id)" required="" style="width:150px;">
                            ...
                            <td style="padding:5px;">
                                <input type="text" value="1" id="quantity_0" name="quantity[]" onkeydown="validateNumberInput(event)" oninput="getTotalAmount(this, event)" class="form-control" sequence=0 onkeyup="getamount(this, event)" required="" onkeyup="getamount(this, event)">
                            </td>
                            <td style="padding:5px;">
                                <input type="text" value="" id="discounteach_0" onkeydown="validateNumberInput(event)" name="discounteach[]" class="form-control" sequence=0 onkeyup="getamount(this, event)">
                            </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <table width="100%" class="table-responsive table table-bordered table-striped " id="summary">
                                ...
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="display: none;" id="director_discount_container">
                                        <b>D.Discount(<span id="director_discount_percentage_show"></span>)%</b>
                                        <input style="width:200px;float: right;" type="text" name="director_discount" id="director_discount" class="form-control">
                                ...
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Total Discount</b>
                                        <input type="text" style="width:200px;float: right;" readonly class="form-control" id="total_discount" placeholder="" name="total_discount">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" valign="middle" style="padding:5px;">
                                        <b>Dis. Reference</b>
                                        <input type="text" style="width:200px;float: right;" class="form-control" id="discount_reference" placeholder="Enter Discount Ref.." name="discount_reference">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                ...
                                <tr>
                                    <td colspan="4" align="right" valign="middle" style="padding:5px;">
                                        <b>Due:&nbsp;</b>
                                        <input type="text" name="due" id="due_sale" readonly="" class="form-control" style="width:200px;float: right;" value="0">
                                    </td>
                                </tr>
