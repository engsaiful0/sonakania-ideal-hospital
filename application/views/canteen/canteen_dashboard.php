    ...
    <?php if (in_array('canteen_dashboard', $permissions)) { ?>
        ...
        <div class="panel panel-primary" style="width: 100%; margin: 0 auto;">
            <div class="panel-heading">
                <h3 style="text-align: center;">Canteen Dashboard</h3>
            </div>
            <div class="panel-body">
                ...
                $total_sell_amount_today = $this->db->select_sum('total')
                    ->where('date', $today) // Filter for today's date
                    ->get('canteen_ready_item_sell')
                    ->row()
                    ->total;

                $total_purchase_amount_today = $this->db->select_sum('paid')
                    ->where('date', $today) // Filter for today's date
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="card l-bg-cherry">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Totday Sell </h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                        <?php
                                        echo number_format($total_sell_amount_today);
                                        ?>
                                    </h2>
                                </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Today Purchase </h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 style="color: white;" class="d-flex align-items-center mb-0">
                        ...
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 style="color: white;" class="d-flex align-items-center mb-0">
                                        <?php
                                        echo number_format($total_sell_amount_today - $total_purchase_amount_today);
                                        ?>
                                    </h2>
                                </div>
