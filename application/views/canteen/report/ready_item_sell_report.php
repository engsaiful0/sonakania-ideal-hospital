<script>
    function ready_item_sell_report_details() {
        ...
        window.open(
            '<?php echo site_url('ReportCanteenController/ready_item_sell_report_details'); ?>' + "/" + ids,
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 style="text-align: center">Ready Item Sell Report</h3>
    </div>
    <div class="panel-body">
        <table class="table">
            <tr>
                ...
                <td><input type="submit" class="btn btn-primary " onclick="ready_item_sell_report_details()" value="Search"></td>
            </tr>
        </table>

        <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img" style="display:none" />
        <div id="ready_item_sell_report_details">
