...
/**
 * Description of ReportIssueController
 *
 * @author saiful
 */
class ReportIssueController extends CI_Controller
{
    ...
    public function department_issue_report()
    {

        $page_data = array(
            'page_name' => 'issue/report/department_issue_report',
            'page_title' => 'Department Issue Report ',
    ...
    public function due_report_details_load($ids)
    {
        $data = array();
        $data = explode("_", $ids);
        $data['from_date'] = $data[0];
        $data['to_date'] = $data[1];
        $this->load->view('report/due_report_details', $data);
    }

    public function due_report()
    {
        $page_data = array(
            'page_name' => 'report/due_report',
