...
/**
 * Description of ReportIPDController
 *
 * @author saiful
 */
class ReportIPDController extends CI_Controller
{
    ...
    {
        $page_data = array(
            'page_name' => 'ipd_patient/report/ipd_patient_report',
    ...
    public function ipd_patient_report_details($ids)
    {
        $data = array();
        ...
        $data['status'] = $ids_array[2];
        $this->load->view('ipd_patient/report/ipd_patient_report_details', $data);
    }
