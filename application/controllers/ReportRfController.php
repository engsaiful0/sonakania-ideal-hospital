 ...
 * @author saiful
 */
class ReportRfController extends CI_Controller
{
    ...
    public function doctor_rf_report()
    {
        
        $page_data = array(
            'page_name' => 'rf_report/doctor_rf_report',
            'page_title' => 'Doctor RF Report ',
            'sidebar' => 'report/report_sidebar'
        );
        $this->load->view('content', $page_data);
    }

    public function doctor_rf_report_details_load($ids)
    {
        ...
        $this->load->view('rf_report/doctor_rf_report_details_load', $data);
    }
